...
def covid():
    ...
    return render_template("index.html", data = india_data, countries = {}, world = {})
...
#     return render_template("world.html", countries = {}, world = world_data)
...
def country_api():
    countries_data_url = "https://coronavirus-tracker-api.herokuapp.com/v2/locations"
    countries_content = requests.get(countries_data_url)
    countries_data_all = countries_content.json()

    return countries_data_all
